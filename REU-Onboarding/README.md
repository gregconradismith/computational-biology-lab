...
- `!`: short-term assignments and project ideas
- `@`: papers or books of interest
- `^`: tools, tutorials, videos, documentation, and other useful links
- `&`: deep background materials

## Contents

- [Start Here](start-here/README.md) (3 notes)
- [Assignments](assignments/README.md) (6 notes)
- [Project Ideas](project-ideas/README.md) (4 notes)
